...
export const courseReadingListIndicatorHtml = (debugFillColour = '#51247a') => {
    const contentIndicatorIconHtml = `
<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
    <path fill="${debugFillColour}" d="M4 10h3v7H4zm6.5 0h3v7h-3zM2 19h20v3H2zm15-9h3v7h-3zm-5-9L2 6v2h20V6z"></path>
</svg>`;
